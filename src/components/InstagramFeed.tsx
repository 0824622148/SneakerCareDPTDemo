...
const posts = [
  ...
  { src: "/images/promo-r99-use.png",       likes: "2.1K", views: "12K"  },
...
export default function InstagramFeed() {
  ...
  return (
    <section id="instagram" className="relative py-24 bg-bg-primary overflow-hidden">
      <div className="absolute top-0 right-1/4 w-80 h-80 rounded-full bg-brand/5 blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-10">
          {posts.map((post, i) => (
            ...
            >
              <Image src={post.src} alt="Instagram post" fill className="object-cover transition-transform duration-500 group-hover:scale-110" />
              ...
              <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-1.5 text-white">
        ...
        >
          <GlowButton href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" variant="ghost" size="lg">
